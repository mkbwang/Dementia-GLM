...
To take a closer look, we calculate the odds ratio and carry out a pearson chi-square test for each pair of variables(including the response variable dementia). The odds ratio and the p values of the test are printed below,
